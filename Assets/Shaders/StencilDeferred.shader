Shader "Custom/StencilDeferred"
{
    ...
    half4 DeferredShading(Varyings input) : SV_Target
    {
        ...
        half4 gbuffer3 = SAMPLE_TEXTURE2D_X_LOD(_CustomGBuffer3, my_point_clamp_sampler, screen_uv, 0);
        #endif
        ...
        InputData inputData = InputDataFromGbufferAndWorldPosition(gbuffer2, posWS.xyz);
            ...
            #endif
            GBufferData buffer = DecodeGBuffer(d, gbuffer0, gbuffer1, gbuffer2, gbuffer3);
            color = AnimeDeferredLighting(buffer, unityLight, inputData.viewDirectionWS);
